...
use Pistas\Core\service\IArtistaService;
...
/**
 * servicio para Artista
 *  
 * @author Marcos
 * @since 16-03-2018
 *
 */
class ArtistaServiceImpl extends CrudService implements IArtistaService {

	
	protected function getDAO(){
		return DAOFactory::getArtistaDAO();
	}
