...
class PistasUtils {
	...
	public static function sendMailPop($nameFrom, $from,$nameTo, $to, $subject, $msg, $attachs) {

		/*$libsHome= PistasConfig::getInstance()->getLibsPath();
		...
		if( PistasConfig::TEST_MODE ){
			//me los envÃ­o todos a mi en test
			$to = PistasConfig::TEST_MAIL_TO;
		}
		...
		$mail->Host = PistasConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = PistasConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = PistasConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = PistasConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = PistasConfig::POP_MAIL_PASSWORD;
	...
	public static function sendMail($nameFrom, $from,$nameTo, $to, $subject, $msg, $attachs='') {

		 
		 
		if (PistasConfig::MAIL_ENVIO_POP)
		self::sendMailPop($nameFrom, $from,$nameTo, $to, $subject, $msg, $attachs);
		else {
